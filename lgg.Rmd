---
title: "Analysis of the LGG data"
...
if(!file.exists("TCGA20161202_LGG_GCcontFullQuantile.RData")) {
  load("TCGA20161202_LGG_Level3.RData")
  ...
  ###
  save(normCounts, geneInfo, sample_map, file = "TCGA20161202_LGG_GCcontFullQuantile.RData")
} else {
  load("TCGA20161202_LGG_GCcontFullQuantile.RData")
}
```
