...
rm(list = ls()) 
setwd("~/Dropbox/AWST/gitHub/lgg20201228_townes//")
jobName <- "LGG20201228"
library(awst)
library(EDASeq)
library(scales)
...
if(save_plots & (what %in% c("HVG10212", "AWST10212"))) {
  mmain <- ""
  png(paste0(jobName, "_plot_hclust_townes_", what, ".png"), width= png_width_large, height= png_height_large, res = png_res)
  }
