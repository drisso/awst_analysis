...
png(file = "seqc20190914sil_a.png", width = png_width, height = png_height)
...
text(1, 0.95, "(b)")
add_Calinski_curve()
png(file = "seqc20190914sil_b.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
dev.off()
```
...
text(1, 0.95, "(c)")
add_Calinski_curve()
png(file = "seqc20190914sil_c.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
```
...
text(1, 0.95, "(d)")
add_Calinski_curve()
png(file = "seqc20190914sil_d.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
```
...
text(1, 0.95, "(e)")
add_Calinski_curve()
png(file = "seqc20190914sil_e.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
```
...
text(1, 0.95, "(f)")
add_Calinski_curve()
png(file = "seqc20190914sil_f.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
```
...
text(1, 0.95, "(g)")
add_Calinski_curve()
png(file = "seqc20190914sil_g.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
```
...
text(1, 0.95, "(h)")
add_Calinski_curve()
png(file = "seqc20190914sil_h.png", width = png_width, height = png_height)
ssil <- silhouette(as.numeric(clustering), ddist)
plot(ssil, main = mmain, col = clust.col)
```
...
<tbody>
<tr>
<td><img src="seqc20190914sil_a.png">RSEM data with AWST</td>
<td><img src="seqc20190914sil_e.png">TPM data with gene-wise standardization</td>
</tr>
<tr>
<td><img src="seqc20190914sil_b.png">CPM data with AWST</td>
<td><img src="seqc20190914sil_f.png">TPM data with gene-wise standardization, top 100 genes</td>
</tr>
<td><img src="seqc20190914sil_c.png">CPM data with gene-wise standardization</td>
<td><img src="seqc20190914sil_g.png">TPM data with AWST</td>
</tr>
<tr>
<td><img src="seqc20190914sil_d.png">CPM data with gene-wise standardization, top 100 genes</td>
<td><img src="seqc20190914sil_h.png">TPM data with Hart transformation</td>
</tr>
</tbody>
</table>
...
png(file = paste0("seqc20190914f3sil_", mmark, ".png"), width = png_width, height = png_height)
plot(ssil, main = mmain, col = clust.col)
dev.off()
ppch <- rep(1, 108)
ppch[which(annotation.df$noised != "white")] <- 6
png(file = paste0("seqc20190914f3prcmp_", mmark, ".png"), width = png_width, height = png_height)
...
<tbody>
<tr>
<td><img src="seqc20190914f3sil_a.png">CPM data with gene-wise standardization, top 2,500 genes</td>
<td><img src="seqc20190914f3sil_e.png">RSEM data with AWST</td>
</tr>
<tr>
<td><img src="seqc20190914f3sil_b.png">One third perturbed samples. CPM data top 2,500 genes</td>
<td><img src="seqc20190914f3sil_f.png">One third perturbed samples. RSEM data with AWST</td>
</tr>
<td><img src="seqc20190914f3sil_c.png">Two thirds perturbed samples. CPM data top 2,500 genes</td>
<td><img src="seqc20190914f3sil_g.png">Two thirds perturbed samples. RSEM data with AWST</td>
</tr>
<tr>
<td><img src="seqc20190914f3sil_d.png">All perturbed samples. CPM data top 2,500 genes</td>
<td><img src="seqc20190914f3sil_h.png">All perturbed samples. RSEM data with AWST</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td><img src="seqc20190914f3prcmp_a.png">CPM data with gene-wise standardization, top 2,500 genes</td>
<td><img src="seqc20190914f3prcmp_e.png">RSEM data with AWST</td>
</tr>
<tr>
<td><img src="seqc20190914f3prcmp_b.png">One third perturbed samples. CPM data top 2,500 genes</td>
<td><img src="seqc20190914f3prcmp_f.png">One third perturbed samples. RSEM data with AWST</td>
</tr>
<td><img src="seqc20190914f3prcmp_c.png">Two thirds perturbed samples. CPM data top 2,500 genes</td>
<td><img src="seqc20190914f3prcmp_g.png">Two thirds perturbed samples. RSEM data with AWST</td>
</tr>
<tr>
<td><img src="seqc20190914f3prcmp_d.png">All perturbed samples. CPM data top 2,500 genes</td>
<td><img src="seqc20190914f3prcmp_h.png">All perturbed samples. RSEM data with AWST</td>
</tr>
</tbody>
</table>
