...
#  sce <- sce[rowData(sce)$hi_var,]
  ...
  sce <- sc3(sce, ks = k_est, biology = FALSE, n_cores=3,  k_estimator = FALSE, rand_seed=2333333)
...
#  sce <- sce[rowData(sce)$hi_var,]
  ...
  se = RSEC(sce, isCount = FALSE, whichAssay = which_assay, minSizes=5,
                reduceMethod="PCA", nReducedDims=5, ncores=3, random.seed=176201)  
...
save(hhc, nrow_exprData, ncol_exprData, annotation.df, aCalinski,
     ...
     ans_Seurat_raw_LoR, ans_Seurat_awst_LoR,
     ans_Seurat_raw_HiR, ans_Seurat_awst_HiR,
